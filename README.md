...
|--|--|
| 1.22.4.0 | - *[NEW]* Server Specific Settings System - *[NEW]* Settings Commands: -prefix, -permlvl, -joinmsg, -leavemsg, -botmsg - *[UPDATED]* Permission Level System - *[UPDATED]* User Info Command - *[UPDATED]* Updated Music Command: -m channel, -m lockchannel |
